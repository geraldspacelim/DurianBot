import {Modal, Button, Form, Row, Col, FormControl, InputGroup} from 'react-bootstrap';
          ...
          <Form onSubmit={addPromo}>
            ...
            <Row className="mb-3">
              <Form.Group as={Col}   controlId="formGridCity">
                ...
                <Form.Control placeholder="PROMOCODE" type="text" value={code} onChange={(e) => setCode(e.target.value)}/>
              </Form.Group>
